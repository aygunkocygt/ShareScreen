...
INSERT INTO "new_Room" ("createdAt", "description", "id", "name", "obsIp", "obsPassword", "obsPort", "userId") SELECT "createdAt", "description", "id", "name", "obsIp", "obsPassword", "obsPort", "userId" FROM "Room";
DROP TABLE "Room";
